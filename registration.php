...
$sql="INSERT INTO tblpenyewa(UniqueId,FirstName,LastName,EmailId,Password,Gender,Dob,Address,City,Country,Phonenumber,Status) VALUES(:uniqueid,:fname,:lname,:email,:password,:gender,:dob,:address,:city,:country,:mobileno,:status)";
...
if($lastInsertId)
{
echo "Akun anda sukses dibuat, silahkan login";
sleep(5);
...
error:function (){}
   ...
   <main class="mn-inner">
                <div class="row">
                    <div class="col s12">
                        <div class="page-title"><a href="index.php">Home</a> >> Form Registrasi</div>
                    </div>
...
<label for="empcode">Unique Code</label>
