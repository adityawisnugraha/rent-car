...
$con="update tblpenyewa set Password=:newpassword where id=:empid";
        ...
        <div class="mn-content fixed-sidebar">
          ...
          <div class="footer">
            ...
            <main class="mn-inner">
                <div class="row">
                    <div class="col s12">
                        <div class="page-title"><h4>Aplikasi Rental Mobil</h4></div>

                          <div class="col s12 m6 l8 offset-l2 offset-m3">
                              <div class="card white darken-1">

                                  <div class="card-content ">
                                      <span class="card-title" style="font-size:20px;">Users details</span>
...
{
$uniqueid=$_POST['empid'];
$email=$_POST['emailid'];
$sql ="SELECT id FROM tblpenyewa WHERE EmailId=:email and UniqueId=:uniqueid";
