...
$sql="update tblsopir set NIKSopir=:niksopir,NamaSopir=:namasopir where NIKSopir=:lid";
$query = $dbh->prepare($sql);
$query->bindParam(':niksopir',$sopir,PDO::PARAM_STR);
$query->bindParam(':namasopir',$niksopir,PDO::PARAM_STR);
...
<?php
$lid=intval($_GET['nik']);
$sql = "SELECT * from tblsopir where NIKSopir=:lid";
$query = $dbh -> prepare($sql);
$query->bindParam(':lid',$lid,PDO::PARAM_STR);
$query->execute();
...
<input id="leavetype" type="text"  class="validate" autocomplete="off" name="leavetype" value="<?php echo htmlentities($result->NIKSopir);?>"  required>
