...
$sql="update tblpenyewa set FirstName=:fname,LastName=:lname,Gender=:gender,Dob=:dob,Address=:address,City=:city,Country=:country,Phonenumber=:mobileno where id=:eid";
...
$query->execute();
$msg="Data penyewa sukses diupdate";
}
...
.succWrap{
  ...
  <?php include('includes/header.php');?>
   ...
   <main class="mn-inner">
                <div class="row">
                    <div class="col s12">
                        <div class="page-title">Update Penyewa</div>
                    </div>
...
<?php 
$eid=intval($_GET['empid']);
$sql = "SELECT * from  tblpenyewa where id=:eid";
$query = $dbh -> prepare($sql);
$query -> bindParam(':eid',$eid, PDO::PARAM_STR);
$query->execute();
...
<label for="empcode">Id Penyewa</label>
<input  name="empcode" id="empcode" value="<?php echo htmlentities($result->UniqueId);?>" type="text" autocomplete="off" readonly required>
